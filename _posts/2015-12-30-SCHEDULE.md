...
|   |    |(통계 토막지식) 실험설계와 오즈비(odds ratio) |하헌철|[slide](https://drive.google.com/file/d/0Bw594TdiBdAUaTM5X2dpOV90dWc/view)|
|   |    |(SparkML) 6. Building a Regression Model with Spark |최정원|[code](https://github.com/psygrammer/ScalaML/blob/master/part1/study12/sparkml/regression.scala)|
...
|   |    |(SparkML) 8. Dimensionality Reduction with Spark |지용기|[note](http://nbviewer.ipython.org/github/psygrammer/ScalaML/blob/master/part2/study06/sparkml/08%EC%9E%A5-Dimensionality-Reduction-with-Spark.ipynb)|
